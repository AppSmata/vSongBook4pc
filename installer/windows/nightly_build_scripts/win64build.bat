...
::git clone -b %BRANCH% https://github.com/vSongBook/vSongBook4PC.git "%DB4S_DIR%Win64"
...
cmake -G "Visual Studio 15 2017 Win64" -Wno-dev C:\\git_repos\\vSongBook
...
cmake -G "Visual Studio 15 2017 Win64" -Wno-dev -Dsqlcipher=1 C:\\git_repos\\vSongBook
...
MOVE %CD%\zip\System64\* "%CD%\zip\vSongBook"
%ZIP_EXE% a "DB.Browser.for.SQLite-%RUN_DATE%-win64.zip" "%CD%\zip\vSongBook"
RMDIR /S /Q %CD%\zip
