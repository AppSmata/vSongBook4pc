...
!define INSTALLER_NAME "D:\cpp\vSongBook4PC\publish\Output\vSongBook${VERSION}_x86.exe"
...
SetOutPath "$INSTDIR"
File "D:\cpp\vSongBook4PC\bin\Release_x86\vSongBook.exe"
SetOutPath "$INSTDIR\Data"
File "D:\cpp\vSongBook4PC\bin\Release_x86\Data\Language.db"
File "D:\cpp\vSongBook4PC\bin\Release_x86\Data\Settings.db"
File "D:\cpp\vSongBook4PC\bin\Release_x86\Data\Songs.db"
SetOutPath "$INSTDIR\res"
File "D:\cpp\vSongBook4PC\bin\Release_x86\res\splash.bmp"
SectionEnd
...
CreateShortCut "$SMPROGRAMS\vSongBook\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$SMPROGRAMS\vSongBook\Uninstall ${APP_NAME}.lnk" "$INSTDIR\uninstall.exe"

!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} website.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\vSongBook\${APP_NAME} Website.lnk" "$INSTDIR\${APP_NAME} website.url"
!endif
!endif
